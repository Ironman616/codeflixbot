...
USERNAME = environ.get('USERNAME', 'https://telegram.me/lokii2030')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
DATABASE_URI = environ.get('DATABASE_URI', "")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://lokimava1122:8dl8cYMSeoWuwvKN@lokimava.os0mf.mongodb.net/?retryWrites=true&w=majority&appName=lokimava")
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002077293491'))
